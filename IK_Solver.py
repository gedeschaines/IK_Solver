...
def animate3D(n):
  ...
  i   = np.size(X0) - 1
  X0P = np.array([X0[i],X0[i],ax.get_xlim()[0]],dtype=object)
  Y0P = np.array([Y0[i],ax.get_ylim()[1],Y0[i]],dtype=object)
  Z0P = np.array([ax.get_zlim()[0],Z0[i],Z0[i]],dtype=object)
  line4.set_data(X0P,Y0P)
  line4.set_3d_properties(Z0P) 
  XEP = np.array([XE,XE,ax.get_xlim()[0]],dtype=object)
  YEP = np.array([YE,ax.get_ylim()[1],YE],dtype=object)
  ...
  Y0TP0 = np.array([Y0P[0],YTP[0]],dtype=object)
  Z0TP0 = np.array([Z0P[0],ZTP[0]],dtype=object)
  line7.set_data(X0TP0,Y0TP0)
  line7.set_3d_properties(Z0TP0)
  X0TP1 = np.array([X0P[1],XTP[1]],dtype=object)
  Y0TP1 = np.array([Y0P[1],YTP[1]],dtype=object)
  Z0TP1 = np.array([Z0P[1],ZTP[1]],dtype=object)
  line8.set_data(X0TP1,Y0TP1)
  line8.set_3d_properties(Z0TP1)
  X0TP2 = np.array([X0P[2],XTP[2]],dtype=object)
