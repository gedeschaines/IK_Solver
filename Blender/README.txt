...
with an executing IK_Solver_server progran in order to control the inverse kinematics
of the armature skeleton rig for the Blender robot model.

The robot model's initial pose in specified by the IK_Solver class methods and it's
